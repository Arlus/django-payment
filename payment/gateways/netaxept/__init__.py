...
def authorize(payment_information: PaymentData,
    ...
    The payment infrastructure will create a Transaction object in the database to record the outcome.
    Also, if it turns out the payment is indeed authorized, the payment authorized flag will be updated.
